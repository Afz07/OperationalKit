    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-xl shadow-sm border w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">OperationalKit</h1>
          <p className="text-gray-500 mt-1 text-sm">Sign in to your account</p>
        </div>

        {!anyEnabled ? (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
            <p className="font-medium mb-1">No sign-in method configured</p>
            <p className="text-amber-700">
              Set GitHub or Google OAuth credentials in your environment to enable
              sign-in. See <span className="font-mono">.env.example</span>.
            </p>
          </div>
        ) : (

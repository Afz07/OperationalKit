        ...
        <div className="card p-8 shadow-sm">
          {!anyEnabled ? (
            <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
              <p className="mb-1 font-medium">No sign-in method configured</p>
              <p className="text-amber-700">
                Set GitHub or Google OAuth credentials in your environment to
                enable sign-in. See{" "}
              ...
              {devEnabled && (
                <>
                  ...
                  >
                    <button
                      type="submit"
                      className="w-full rounded-lg border border-dashed border-zinc-300 px-4 py-2.5 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-50"
                    >
